...
types_of_data_professionals_tbl <- data.frame(
    "Type of Data Professional" = c("Data Engineer", "ML Engineer", "Data Scientist", "Data Analyst"),
    "ML Ops" = c(8, 10, 5, 2),
    "Data Pipelines" = c(10, 5, 2, 2),
    "Database" = c(10, 5, 4, 3.5),
    "Data Viz" = c(3, 2, 6, 10),
    "Storytelling" = c(2, 2, 6, 10),
    "Business Insights" = c(2, 2, 6, 10),
    "Reporting" = c(3, 3, 6, 6),
    "Experimentation" = c(2, 8, 9, 5),
    "Stats" = c(3, 8, 10, 4),
    "ML Modeling" = c(4, 9, 10, 2),
    "Deployment" = c(NA, 10, 6, 2)
  )
